...
interface IProps{
  cart: IAllVariantOption[] | undefined
}

export default function MiniCart({ cart }: IProps) {
  ...
  return (
      ...
      <Dialog
        ...
        onClose={() => { 
          if(setCartOpen) setCartOpen(!cartOpen)
        }}
      >
                              ...
                              <div className="ml-4 flex-1 flex flex-col">
                                ...
                                <div className="flex-1 flex items-end justify-between text-sm">
                                  ...
                                  <div className="flex">
                                    <button 
                                      onClick={() => {
                                        if(removeCartItem) removeCartItem(product.id)
                                      }}
                                      type="button" 
